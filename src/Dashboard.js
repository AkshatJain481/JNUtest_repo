                  ...
                  <div className="p-4 border border-gray-400 flex items-center">
                      ...
                      <div className="p-4 flex items-center justify-between space-x-14">
                        ...
                        <div className="flex-none">
                          ...
                          <div class="flex justify-center items-center ml-10 mr-10 ">
...
<div>
<div class="bg-white shadow-md shadow-gray-400 rounded-3xl p-4 w-auto ml-20 mt-10 flex-col justify-center items-center mb-10 ">
...
<div class="card bg-gradient-to-r from-blue-400 to-pink-500 rounded-3xl shadow-lg p-6 mt-10 ml-2 mr-2 mb-2 w-64">
        ...
        <div class="text-4xl font-bold text-white mt-12">
            ₹10,000
        </div>
        <div class="text-white text-opacity-75 mt-2">
          Akshat jain
        </div>
    </div>
                          </div>
